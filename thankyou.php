...
<nav id="navigation">
 ...
 <h1 style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding-top: 300px; padding-bottom: 350px;">
    <CENTer> WE'VE RECEIVED YOUR MESSAGE,
        THANKYOU FOR CHOOSING BUTTER N CREAM!</CENTer>
 </h1>
 <footer>
    <div class="container">
        <div class="">
